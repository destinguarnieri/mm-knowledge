...
| [[research/trading/emac-cross-10-200/emac-cross-10-200|EMA 10/200]] | **Parent research program with a repaired coverage map.** The basic cross has BTC-wide timeframe evidence and multi-asset 4h/lower-timeframe evidence, but 1D is BTC-only. Continuous V1 has no clean standalone baseline; V4 economics are sparse; V5 has no backtest. Band traversal remains supported as a separate branch | Freeze the full point-in-time asset search above `$250k` Hyperliquid rolling 24-hour notional. MON-210 runs every eligible asset at 1D; MON-211 runs every eligible asset at `5m`/`1h`/`4h`/`1d`; MON-165 inherits the exact completed cells for V4/V5. Band-to-band monetization and static-versus-causal thresholds remain independently Ready | None for the independent Ready branches; MON-165 is dependency-blocked on MON-211, not human-blocked | [Project](https://linear.app/money-machine/project/ema-10200-research-b4f25ac9aabd) · [MON-210](https://linear.app/money-machine/issue/MON-210/complete-the-multi-asset-1d-emac-cross-control) · [MON-211](https://linear.app/money-machine/issue/MON-211/establish-the-unthresholded-continuous-emac-v1-baseline) · [MON-165 blocked](https://linear.app/money-machine/issue/MON-165/compare-thresholded-continuous-emac-v5-with-continuous-v1-and-v4) · [MON-157](https://linear.app/money-machine/issue/MON-157/monetize-the-emac-10200-escalation-ladder-edge-band-to-band-traversal) · [MON-167](https://linear.app/money-machine/issue/MON-167/compare-static-and-causal-dynamic-thresholds-in-the-ema-10200-program) |
