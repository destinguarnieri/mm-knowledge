...
| [[research/trading/research-direction-future|Research Directions]] | Destin's standing list of unstarted directions — model set, knowledge extraction, model pipelining, image-based trading, LFM. An input queue, not a commitment; items graduate to a program when a bounded question and evidence surface exist. |
