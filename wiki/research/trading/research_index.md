...
|---|---|---|---|---|
| [[research/trading/vwap-mean-reversion/vwap-mean-reversion|VWAP mean reversion]] | Gross signal retained; no immediate-execution mapping promoted. `±0.9` entry broadly improved the `±0.5` development control but remained negative-median; low-slope semantics also remain open | Review bounded BTC/WLD/NEAR `±0.9` visuals, then choose one next mechanism. Treat future slope work as an event study of level, extremity, signed alignment, and deceleration | Review chart geometry and next mechanism choice | [Project](https://linear.app/money-machine/project/vwap-mean-reversion-research-ec37e0025905) · [MON-163 Done](https://linear.app/money-machine/issue/MON-163/test-vwap-sloperegime-filtering-on-longer-binance-history) · [MON-162](https://linear.app/money-machine/issue/MON-162/specify-and-evaluate-pnl-aware-vwap-resizing) · [MON-164](https://linear.app/money-machine/issue/MON-164/specify-and-evaluate-a-wide-stop-vwap-risk-policy) |
