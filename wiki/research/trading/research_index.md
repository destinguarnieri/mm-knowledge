...
|---|---|---|---|---|
| [[research/trading/vwap-mean-reversion/vwap-mean-reversion|VWAP mean reversion]] | Gross signal retained; no immediate-execution mapping promoted. MON-163 supports normalized VWAP slope as a material risk/regime filter, but threshold+slope remains negative-median | Choose the next isolated branch or preregister a justified combination: PnL-aware resizing, wide stop, later `±0.9` threshold sensitivity, readiness, or 2σ/escalation | Review the next mechanism choice or exact unresolved semantics | [Project](https://linear.app/money-machine/project/vwap-mean-reversion-research-ec37e0025905) · [MON-163 Done](https://linear.app/money-machine/issue/MON-163/test-vwap-sloperegime-filtering-on-longer-binance-history) · [MON-162](https://linear.app/money-machine/issue/MON-162/specify-and-evaluate-pnl-aware-vwap-resizing) · [MON-164](https://linear.app/money-machine/issue/MON-164/specify-and-evaluate-a-wide-stop-vwap-risk-policy) |
...
| [[trading/positioning/size-distribution|Position/control research]] | Linear and nonlinear mappings exist; V1 nonlinear work had logic errors; Citadel-inspired mapping ideas are not yet benchmarked | Correctness audit and pointwise/visual benchmark of linear, banded, nonlinear, and Citadel-inspired mappings | Unresolved economic semantics are recorded, not guessed | [MON-168](https://linear.app/money-machine/issue/MON-168/audit-and-benchmark-nonlinear-signal-to-position-mappings) |
